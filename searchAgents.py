...
class CornersProblem(search.SearchProblem):
    ...
    """
    Represent states as combinations of position and cornersReached
    ...
    def getStartState(self):
        ...
        if self.startingPosition in self.corners:
            state[self.corners.index(self.startingPosition) + 1] = True
    ...
    def getSuccessors(self, state):
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not self.walls[nextx][nexty]:
                ...
                newState = [nextPosition] + oldState[1:]

                if nextPosition in self.corners:
                    newState[self.corners.index(nextPosition) + 1] = True
                    # print('CORNER REACHED')
                cost = 1
                successors.append( ( tuple(newState), action, cost) )
...
def cornersHeuristic(state, problem):
    ...
    """
    Idea: For each corner that has not been reached yet, find the closest corner that has not been reached
    and add the distance to that corner
